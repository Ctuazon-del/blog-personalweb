...
const BlogStore = {
  ...
  async getPosts() {
    ...
    if (localPosts.length) {
      await this.syncLocalPosts(localPosts, serverPosts);
      const refreshedServerPosts = await this.fetchServerPosts();
      return this.dedupePosts([...refreshedServerPosts, ...localPosts, ...defaultPosts]);
    }

    return this.dedupePosts([...serverPosts, ...defaultPosts]);
  },
